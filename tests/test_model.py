...
class ModelTests(unittest.TestCase):
    ...
    def test_rk4_rejects_lost_nonzero_substep_motion(self):
        params = CapabilityParameters(
            A_0=1.0,
            H_0=1.0,
            K_A=1e308,
    ...
    def test_rk4_rejects_reversal_above_capability_barrier(self):
        params = CapabilityParameters(
            A_0=1.0,
            H_0=1.0,
            K_A=1.0,
    ...
    def test_delta_t_change_does_not_silently_rescale_discrete_coefficients(self):
        params = base_parameters()
        state = base_state()
        config = SimulationConfig(delta_t=1.0, ode_substeps=16)
        a = advance_state(state, params, config)
